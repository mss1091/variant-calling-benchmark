#!/usr/bin/env python3
"""Phase 2: Somatic Variant Calling with MuTect2 (Bowtie + COSAP)"""
...
OUTPUT_BASE_DIR = os.path.join(PROJECT_ROOT, "outputs", "phase2", "bowtie", "cosap", "mutect2")
...
def run_pipeline():
    ...
    print("Running COSAP Pipeline: Bowtie + MuTect2")
