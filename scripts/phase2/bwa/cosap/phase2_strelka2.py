#!/usr/bin/env python3
"""Phase 2: Somatic Variant Calling with Strelka2 (BWA + COSAP)"""
...
OUTPUT_BASE_DIR = os.path.join(PROJECT_ROOT, "outputs", "phase2", "bwa", "cosap", "strelka2")
...
def run_pipeline():
    ...
    print("Running COSAP Pipeline: BWA + Strelka2")
