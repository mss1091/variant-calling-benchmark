#!/usr/bin/env python3
"""Phase 1: Germline Variant Calling with HaplotypeCaller (COSAP)"""
...
OUTPUT_BASE_DIR = os.path.join(PROJECT_ROOT, "outputs", "phase1", "cosap", "haplotype_caller")
...
def run_pipeline():
    ...
    print("Running COSAP Pipeline: BWA + HaplotypeCaller")
